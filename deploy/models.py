...
class Site(models.Model):
    ...
    short_name       = models.CharField(max_length=63, null=False, blank=False, help_text='this is the site name, e.g.: foo to create the site www.example.org/foo')
    platform         = models.ForeignKey(Platform, help_text='Which platform should this site be created.')
    database         = models.CharField(max_length=63, null=False, blank=True)
...
"""
        site_vars = {
            ...
            'sitedir': 'default' if self.short_name == 'default' else self.platform.host + '.' +  self.short_name,
